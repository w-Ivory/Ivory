        ...
        <section role="main">
            <article role="article">
                <header>
                    ...
                    <a class="link" href="<?php echo ( isset( $_GET['c'] ) ? '?c=' . $_GET['c'] . '&' : '?' ); ?>a=add" title="">Ajouter un utilisateur</a>
                </header>
                ...
                <ul class="list">
                    ...
                    foreach( $arr_datas as $item ) :
                        echo '
                    <li class="item"><a class="link" href="' . ( isset( $_GET['c'] ) ? '?c=' . $_GET['c'] . '&' : '?' ) . 'a=profile&id=' . $item['ID'] . '" title="' . $item['Nom'] . ' ' . $item['Prénom'] . ' (' . $item['Login'] . ')">' . $item['Nom'] . ' ' . $item['Prénom'] . ' (' . $item['Login'] . ')</a></li>';
                    endforeach;
                    ?>
                </ul>
            </article>
